    ...
    <div class="w-full">
        <div class="bg-white overflow-auto">
            ...
            <div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
                ...
                <!-- Imagem do usuário, e nome do usuário -->
                <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
                    <div class="relative flex items-center space-x-4">
                        <div class="relative">
                            ...
                            <img src="{{ $support->user->image ? url("storage/{$support->user->image}") : url('images/user.png') }}"
                                alt="{{ $support->user->name }}" class="w-10 sm:w-16 h-10 sm:h-16 rounded-full">
                        </div>
                        ...
                        <div class="chat-message">
                            ...
                            @if ($user->id == $support->user->id)
                                <div class="flex items-end">
                                    ...
                                    <img src="{{ $user->image ? url("storage/{$user->image}") : url('images/user.png') }}"
                ...
                <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                    <div class="relative flex">
                        <form action="{{ route('replies.store', $support->id) }}" method="post" class="w-full">
                            ...
                            <input type="text" name="description" placeholder="Escreva a sua resposta"
                                class="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-2 bg-gray-200 rounded-md py-3">
