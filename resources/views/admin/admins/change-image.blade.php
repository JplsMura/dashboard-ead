...
@section('content')
    <h1 class="w-full text-3xl text-black pb-6">Alterar image do administrador: {{ $admin->name }}</h1>
            ...
            <div class="leading-loose">
                <form class="p-10 bg-white rounded shadow-xl" action="{{ route('admins.update.image', $admin->id) }}"
                    ...
                    <div class="mt-2">
                        ...
                        <input class="w-full px-5  py-2 text-gray-700 bg-gray-200 rounded" type="file"
                            placeholder="Image" aria-label="Imagem" name="image">
                    </div>
                    <div class="mt-6">
